"""Fungsi geometri untuk menghitung EAR, MAR, dan estimasi pose kepala."""
...
# Camera convention: x right, y down, z forward; neutral pitch is near 0.
# Titik untuk solvePnP (model wajah 3D generik, satuan arbitrer)
POSE_LANDMARK_IDS = [1, 152, 33, 263, 61, 291]  # hidung, dagu, mata kiri, mata kanan, mulut kiri, mulut kanan
...
def eyes_are_measurable(points, width, height):
    """Reject clipped eyes and eyes too small for meaningful pixel geometry."""
    return all(
